...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| node_pub_key | [string](#string) |  | The node pub key of the peer which to open channel with. |
| currency | [string](#string) |  | The ticker symbol of the currency to open channel for. |
| amount | [int64](#int64) |  | The amount of the channel in the smallest base unit of the currency. |
...
| OpenChannel | [OpenChannelRequest](#xudrpc.OpenChannelRequest) | [OpenChannelResponse](#xudrpc.OpenChannelResponse) | Opens a payment channel given pub key, amount and currency. |
